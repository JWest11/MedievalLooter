...
void UMeleeStrike::PerformStrikeLineTrace()
{
	...
	GetWorld()->LineTraceMultiByChannel(HitResults, InstigatingCharacter->GetWeaponRootLocation(), InstigatingCharacter->GetWeaponTipLocation(), LineTraceCollisionChannel, TraceParams, FCollisionResponseParams::DefaultResponseParam);
