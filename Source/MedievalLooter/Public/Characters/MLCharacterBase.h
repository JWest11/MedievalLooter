...
protected:
	...
	UPROPERTY(ReplicatedUsing = OnRep_Montages)
	TArray<FMontageInfo> Montages;

	UFUNCTION()
	void OnRep_Montages();

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "ML | Montages")
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "ML | Animation")
	void UseAnimMontageSlot(EMontageSlot Slot);

	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "ML | Animation")
	EMontageSlot GetCurrentAnimMontageSlot() const;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "ML | Animation")
	EMontageSlot DefaultAnimMontageSlot;
